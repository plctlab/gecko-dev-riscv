...
void MacroAssemblerriscv64Compat::convertBoolToInt32(Register src,
                                                    Register dest) {
...
void MacroAssemblerriscv64Compat::convertInt32ToDouble(Register src,
                                                      FloatRegister dest) {
  as_mtc1(src, dest);
  as_cvtdw(dest, dest);
}

void MacroAssemblerriscv64Compat::convertInt32ToDouble(const Address& src,
                                                      FloatRegister dest) {
  ma_ls(dest, src);
  as_cvtdw(dest, dest);
}

void MacroAssemblerriscv64Compat::convertInt32ToDouble(const BaseIndex& src,
                                                      FloatRegister dest) {
...
// integer is written to the output register. Otherwise, a bailout is taken to
// the given snapshot. This function overwrites the scratch float register.
void MacroAssemblerriscv64Compat::convertFloat32ToInt32(FloatRegister src,
                                                       Register dest,
                                                       Label* fail,
                                                       bool negativeZeroCheck) {
  if (negativeZeroCheck) {
...
void MacroAssemblerriscv64Compat::movq(Register rs, Register rd) {
  ma_move(rd, rs);
}
...
void MacroAssemblerriscv64::ma_dnegu(Register rd, Register rs) {
  as_dsubu(rd, zero, rs);
}

// Shifts
void MacroAssemblerriscv64::ma_dsll(Register rd, Register rt, Imm32 shift) {
  if (31 < shift.value) {
...
void MacroAssemblerriscv64::ma_dsrl(Register rd, Register rt, Imm32 shift) {
  if (31 < shift.value) {
...
void MacroAssemblerriscv64::ma_dsra(Register rd, Register rt, Imm32 shift) {
  if (31 < shift.value) {
...
void MacroAssemblerriscv64::ma_dror(Register rd, Register rt, Imm32 shift) {
  if (31 < shift.value) {
...
void MacroAssemblerriscv64::ma_drol(Register rd, Register rt, Imm32 shift) {
...
void MacroAssemblerriscv64::ma_dsll(Register rd, Register rt, Register shift) {
  as_dsllv(rd, rt, shift);
}

void MacroAssemblerriscv64::ma_dsrl(Register rd, Register rt, Register shift) {
  as_dsrlv(rd, rt, shift);
}

void MacroAssemblerriscv64::ma_dsra(Register rd, Register rt, Register shift) {
  as_dsrav(rd, rt, shift);
}

void MacroAssemblerriscv64::ma_dror(Register rd, Register rt, Register shift) {
  as_drotrv(rd, rt, shift);
}

void MacroAssemblerriscv64::ma_drol(Register rd, Register rt, Register shift) {
  as_dsubu(ScratchRegister, zero, shift);
  as_drotrv(rd, rt, ScratchRegister);
}

void MacroAssemblerriscv64::ma_dins(Register rt, Register rs, Imm32 pos,
                                   Imm32 size) {
...
void MacroAssemblerriscv64::ma_dext(Register rt, Register rs, Imm32 pos,
                                   Imm32 size) {
  if (pos.value >= 0 && pos.value < 32) {
    if (size.value > 32) {
...
void MacroAssemblerriscv64::ma_dsbh(Register rd, Register rt) {
  as_dsbh(rd, rt);
}

void MacroAssemblerriscv64::ma_dshd(Register rd, Register rt) {
  as_dshd(rd, rt);
}

void MacroAssemblerriscv64::ma_dctz(Register rd, Register rs) {
...
// Add.
void MacroAssemblerriscv64::ma_daddu(Register rd, Register rs, Imm32 imm) {
...
void MacroAssemblerriscv64::ma_daddu(Register rd, Register rs) {
  as_daddu(rd, rd, rs);
}

void MacroAssemblerriscv64::ma_daddu(Register rd, Imm32 imm) {
  ma_daddu(rd, rd, imm);
}

void MacroAssemblerriscv64::ma_add32TestOverflow(Register rd, Register rs,
...
void MacroAssemblerriscv64::ma_addPtrTestOverflow(Register rd, Register rs,
                                                 Register rt, Label* overflow) {
...
// Subtract.
void MacroAssemblerriscv64::ma_dsubu(Register rd, Register rs, Imm32 imm) {
  if (Imm16::IsInSignedRange(-imm.value)) {
    as_daddiu(rd, rs, -imm.value);
  } else {
    ma_li(ScratchRegister, imm);
...
void MacroAssemblerriscv64::ma_dsubu(Register rd, Register rs) {
  as_dsubu(rd, rd, rs);
}

void MacroAssemblerriscv64::ma_dsubu(Register rd, Imm32 imm) {
  ma_dsubu(rd, rd, imm);
}

void MacroAssemblerriscv64::ma_sub32TestOverflow(Register rd, Register rs,
                                                Register rt, Label* overflow) {
...
void MacroAssemblerriscv64::ma_subPtrTestOverflow(Register rd, Register rs,
                                                 Register rt, Label* overflow) {
  SecondScratchRegisterScope scratch2(asMasm());
...
void MacroAssemblerriscv64Compat::computeEffectiveAddress(
...
// Branches when done from within riscv-specific code.
...
void MacroAssemblerriscv64::ma_b(Address addr, ImmGCPtr imm, Label* label,
                                Condition c, JumpKind jumpKind) {
  ma_load(SecondScratchReg, addr, SizeDouble);
  ma_b(SecondScratchReg, imm, label, c, jumpKind);
}

void MacroAssemblerriscv64::ma_bal(Label* label, DelaySlotFill delaySlotFill) {
...
void MacroAssemblerriscv64::branchWithCode(InstImm code, Label* label,
                                          JumpKind jumpKind) {
...
void MacroAssemblerriscv64::ma_cmp_set(Register rd, Register rs, ImmWord imm,
                                      Condition c) {
  if (imm.value <= INT32_MAX) {
...
void MacroAssemblerriscv64::ma_cmp_set(Register rd, Register rs, ImmPtr imm,
                                      Condition c) {
...
void MacroAssemblerriscv64::ma_mv(FloatRegister src, ValueOperand dest) {
  as_dmfc1(dest.valueReg(), src);
}

void MacroAssemblerriscv64::ma_mv(ValueOperand src, FloatRegister dest) {
  as_dmtc1(src.valueReg(), dest);
}

void MacroAssemblerriscv64::ma_ls(FloatRegister ft, Address address) {
  if (Imm16::IsInSignedRange(address.offset)) {
...
void MacroAssemblerriscv64::ma_ld(FloatRegister ft, Address address) {
  if (Imm16::IsInSignedRange(address.offset)) {
...
void MacroAssemblerriscv64::ma_sd(FloatRegister ft, Address address) {
  if (Imm16::IsInSignedRange(address.offset)) {
...
void MacroAssemblerriscv64::ma_ss(FloatRegister ft, Address address) {
  if (Imm16::IsInSignedRange(address.offset)) {
...
void MacroAssemblerriscv64Compat::loadUnalignedDouble(
...
void MacroAssemblerriscv64Compat::loadUnalignedFloat32(
    const wasm::MemoryAccessDesc& access, const BaseIndex& src, Register temp,
    FloatRegister dest) {
  computeScaledAddress(src, SecondScratchReg);
  BufferOffset load;
...
void MacroAssemblerriscv64Compat::storeUnalignedFloat32(
...
void MacroAssemblerriscv64Compat::storeUnalignedDouble(
    const wasm::MemoryAccessDesc& access, FloatRegister src, Register temp,
    const BaseIndex& dest) {
  computeScaledAddress(dest, SecondScratchReg);
...
void MacroAssemblerriscv64Compat::unboxInt32(const Address& src, Register dest) {
...
void MacroAssemblerriscv64Compat::int32ValueToDouble(const ValueOperand& operand,
                                                    FloatRegister dest) {
  convertInt32ToDouble(operand.valueReg(), dest);
}

void MacroAssemblerriscv64Compat::boolValueToFloat32(const ValueOperand& operand,
                                                    FloatRegister dest) {
  convertBoolToInt32(operand.valueReg(), ScratchRegister);
...
void MacroAssemblerriscv64Compat::breakpoint() { as_break(0); }
...
void MacroAssemblerriscv64Compat::checkStackAlignment() {
#ifdef DEBUG
  Label aligned;
