...
// TODO(riscv64): this is just a filler to prevent a build failure. The
...
// TODO(riscv64): Add LoongArch instruction types description.
...
class AssemblerLOONG64 : public AssemblerShared {
 public:
  // TODO(riscv64): Should we remove these conditions here?
  enum Condition {
    Equal,
    NotEqual,
    Above,
