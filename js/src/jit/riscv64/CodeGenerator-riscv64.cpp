...
template <typename T>
void CodeGeneratorriscv64::emitWasmLoadI64(T* lir) {
...
template <typename T>
void CodeGeneratorriscv64::emitWasmStoreI64(T* lir) {
...
void CodeGenerator::visitWasmExtendU32Index(LWasmExtendU32Index*) {
  MOZ_CRASH("Unused - no support on riscv64 for indices > INT_MAX");
}
