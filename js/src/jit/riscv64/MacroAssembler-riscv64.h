...
class MacroAssemblerriscv64Compat : public MacroAssemblerriscv64 {
 public:
  ...
  // Emit a branch that can be toggled to a non-operation. On riscv64 we use
  ...
  static size_t ToggledCallSize(uint8_t* code) {
    // Six instructions used in: MacroAssemblerriscv64Compat::toggledCall
 ...
 public:
  ...
  // NOTE: This will use second scratch on riscv64. Only ARM needs the
